...
using Microsoft.WebHook.Properties;
...
namespace Microsoft.AspNetCore.WebHooks.Filters
{
    ...
    public abstract class WebHookSecurityFilter : IOrderedFilter
    {
        ...
        //protected virtual async IActionResult EnsureValidCode(string receiverName,HttpRequest request)
        //{
        //    if (request == null)
        //    {
        //        throw new ArgumentNullException(nameof(request));
        ...
        //    {
        //        var code=queryParameters.Value;
        //        if(string.IsNullOrEmpty(code))
        //        {
        //            var message = string.Format(CultureInfo.CurrentCulture, "The WebHook verification request must contain a '{0}' query parameter.", "code");
        //            var resp = new HttpResponseMessage(System.Net.HttpStatusCode.NotImplemented)
        //            {
